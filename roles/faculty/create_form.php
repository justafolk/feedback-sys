												...
												<div class="question2">
													<div class="card my-2 shadow-none border">
														<div class="card-body">
															...
															<div class="sliders2">
																<input type="text" style="border: 0px; outline:none; background-color:transparent" placeholder="Enter Range Question key" name="slider-title slider-title2-1" id="
                        slider-title2-1" class="form-label slider-title">
																<ul class="justify-content-between d-flex ml-0 pl-0" style="list-style: none">
																	<li class="">Very Bad</li>
																	<li>Bad</li>
																	<li>Neutral </li>
