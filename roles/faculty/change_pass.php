                                ...
                                <div class="card-body">
                                    <form action="" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" id="oldpass" name="oldpass" placeholder="Contact Admin if you forgot your old password" required>
                                        </div>
                                        <br />
                                        <div class="form-group">
...
if(isset($_POST['changepass'])){
    ...
    $sql = "SELECT * FROM `login` WHERE uname = '$uname' AND `passwd` = '$oldpass'";
    $result = mysqli_query($conn, $sql);
    //$row = mysqli_fetch_assoc($result);
    $count = mysqli_num_rows($result);
    if($count == 1){
        if($newpass == $confirmpass){
            $sql = "UPDATE `login` SET `passwd` = '$newpass' WHERE `uname` = '$uname'";
            $result = mysqli_query($conn, $sql);
            if($result){
