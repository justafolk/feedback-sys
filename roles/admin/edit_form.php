										...
										<form action="./create_feedback.php" method="post">
											...
											<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 border-bottom  ">
												<div class="row">
													<div class="col-md-12">
														<?php
														$sql = "select * from courses where course_code = '" . $main_row['course_name'] . "'";
														$result = mysqli_query($conn, $sql);
														$row = mysqli_fetch_assoc($result);
														?>
														<h3 class="h2 mb-0">
															<strong>
																<input type="text" name="form-title" id="form-title" value="<?php echo $row["course_name"] . " " . $main_row["course_name"] ?>" style="background-color: transparent;width:100%; outline:none; border:0px" placeholder="Enter Form Name">
															</strong>
														</h3>
													</div>
													...
													<div class="col-md-12">
														<h6 class="">
															<div class="h7">
																<input type="text" name="form-title" id="form-title" style="background-color: transparent; outline:none; border:0px" placeholder="-Teacher Name">
															</div>
														</h6>
													</div>
												</div>
											...
											<div class="card " style="background-color: transparent; border:1px solid black">
												<div class="card-body">
													<div class="row">
														...
														- Please fill in the details of the student who is taking the course.">
														<?php
