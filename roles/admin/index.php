			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="row">
						...
						<?php
						$sql = "select * from forms order by ini_date desc LIMIT 2";
						$result = mysqli_query($conn, $sql);
						$i = 0;
						while ($row = mysqli_fetch_assoc($result)) {
							$course = "select * from courses where course_code = " . $row['course_code'];
						...
						?>
							<div class="col-12 col-md-6 col-xxl-3 order-1 order-xxl-1">
								<div class="card flex-fill w-100">
									...
									<div class="card-header d-flex justify-content-between">
										<div>
											<h5 class="card-title mb-0"><?php echo $course_row["course_code"] ?> - Feedback</h5>
											<h6 class="card-title mb-0"><?php echo $row["ini_date"] ?></h6>
										</div>
										...
										<div class="align-self-center w-100">
											<div class="py-3">
												<div class="chart chart-xs">
													<canvas id="chartjs-dashboard-pie<?php echo $i ?>"></canvas>
												</div>
											</div>
							...
							<script>
								document.addEventListener("DOMContentLoaded", function() {
									// Pie chart
									new Chart(document.getElementById("chartjs-dashboard-pie<?php echo $i;$i++; ?>"), {
										type: "pie",
										data: {
						...
						<?php } ?>
						<div class="col-12 col-md-6 col-xxl-3 order-1 order-xxl-1">
							<p class="h3" style="margin-top:10%;">
							<p>
							<div class="card flex-fill w-100">
								<div class="card-header d-flex justify-content-between">
									<div>
