	...
	<div class="wrapper">
            ...
            <ul class="sidebar-nav">
                ...
                <ul id="charts-nav" class="collapse" style="list-style-type:none;">
					...
					<li class="sidebar-item active">
						<a class="sidebar-link active" href="etc_department_a.php">
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
			...
			<div>
				<h1 class="h3 mb-0"><strong>Feedback | E&TC Department (Aided)</strong></h1>
			</div>
			<?php
			...
			<main class="content">
				<div class="container-fluid p-0">
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle" id="name">E&TC Department (Aided)</h1>
					</div>
