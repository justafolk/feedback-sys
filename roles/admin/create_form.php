	...
	<div class="wrapper">
		...
		<div class="main">
			<nav class="navbar navbar-expand navbar-light navbar-bg">
				...
				<div>
					<h1 class="h3 mb-0"><strong>Create Form</strong></h1>
				</div>
											...
											<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 border-bottom  ">
												<div class="row">
													<div class="col-md-12">
														<h3 class="h2 mb-0">
															<strong>
																<input type="text" name="form-title" id="form-title" style="background-color: transparent; outline:none; border:0px" placeholder="Enter Form Name">
															</strong>
														</h3>
													</div>
