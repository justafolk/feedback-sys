            ...
            <div class="card-body">
                ...
                slider-title<?php echo $id ?>-1" class="form-label slider-title">
                    <ul class="slider-list" >
                        <li class="slider-listi" style="text-align:left; align-items:left;">Very Bad </li>
                        <li class="slider-listi" style="padding-left:4%;text-align:left; align-items:left;">Bad</li>
                        <li class="slider-listi" style="text-align:center; align-items:center;">Neutral </li>
                        <li class="slider-listi" style="text-align:right;padding-right:4%; align-items:right;">Good</li>
                        <li class="slider-listi" style="text-align:right; align-items:right;">Excellent</li>
                    </ul>
